...
def train(args):
	cmdline = [
		...
		'scripts/train.sh', args.model, args.data_name
	]
...
def main():
	...
	train_parser.add_argument('-dn', '--data_name', type=str, required=True)
	train_parser.add_argument('-m', '--mem', type=int, default=100000)
	train_parser.add_argument('-g', '--gpus', type=int, default=2)
	train_parser.add_argument('-c', '--cpus', type=int, default=8)
	...
	predict_parser.add_argument('-g', '--gpus', type=int, default=2)
	predict_parser.add_argument('-c', '--cpus', type=int, default=8)
