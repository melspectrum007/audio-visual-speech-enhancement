...
s = source.get_data().astype('f')
mag = lb.magphase(lb.stft(s, 640, 160))[0]
mel_filters = lb.filters.mel(16000, 640, 80, fmin=0, fmax=8000)
mag1 = np.dot(mel_filters, mag)
mag2 = lb.amplitude_to_db(mag1)
print 'bye!'
