...
def pesq(pesq_bin_path, source_file_path, enhanced_file_path):
	...
	try:
		output = subprocess.check_output(
			[pesq_bin_path, "+16000", source_file_path, enhanced_file_path]
		)
	except Exception:
		return None, None
...
def evaluate(enhancement_dir_path, pesq_bin_path):
	...
	for speaker_dir_name in speaker_dir_names:
		...
		sample_dir_names = os.listdir(speaker_dir_path)
		for sample_dir_name in sample_dir_names:
			...
			print 'mixture pesq: ', mixture_mos, 'enhanced pesq: ', enhanced_mos, 'mixture pesq lqo: '
